...
corr_df.to_csv("corr_xlm_r.csv", index=False)
...
test_df["xlm_r_pred"] = label_scaler.inverse_transform(pred.reshape(-1, 1))
...
train_df["xlm_r_pred"] = label_scaler.inverse_transform(train_pred.reshape(-1, 1))
