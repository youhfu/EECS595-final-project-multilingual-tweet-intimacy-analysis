...
bert_tokenizer = DebertaV2Tokenizer.from_pretrained(bert_model)
...
class bertRegressor(nn.Module):
    def __init__(self, bert_model, dropout=0.1):
        ...
        self.bert = DebertaV2ForSequenceClassification.from_pretrained(
...
corr_df.to_csv("corr_deberta.csv", index=False)
...
test_df["debert_pred"] = label_scaler.inverse_transform(pred.reshape(-1, 1))
...
train_df["debert_pred"] = label_scaler.inverse_transform(train_pred.reshape(-1, 1))
